...
import img00 from './image/logo1.svg';
...
// SLIDER 
var slider = [     
  { image: require("./image/asset 1.webp") },
  { image: require("./image/asset 2.webp") },
  { image: require("./image/asset 4.webp") },
  { image: require("./image/asset 5.webp") },
  { image: require("./image/asset 6.jpeg") },
]
...
var choose = [
  { image: require('./image/read.png'), head: "Industry Expert As Trainers", para: "Our trainers have 5+ years of industry experience coupled with extensive research and analysis." },
  { image: require('./image/read1.png'), head: "Latest Curriculum", para: "We Provides latest curriculum for all courses which designed in such a way that Students will get full knowledge within a short time.." },
  { image: require('./image/read2.png'), head: "Latest Technology", para: "At the end of each training,our training instructor will go through the possible technical questions you may be asked." },
  { image: require('./image/read3.png'), head: "Interview Assistance", para: "We will be provided free upgradation for any newer version of the course you have." },
  { image: require('./image/read4.png'), head: "Free Upgradation", para: "At the end of each training,our training instructor will go through the possible technical questions you may be asked." },
  { image: require('./image/read5.png'), head: "Lifetime Support", para: "We will provide you lifetime support on all the courses you learned from us." },
]
